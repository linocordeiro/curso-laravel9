...
@section('content')
    ...
    <form action="{{ route('users.index') }}" method="get" class="py-5">
        ...
        <a href="{{ route('users.report') }}" target="_blank"
            class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 mb-10 rounded">Gerar
            Relatório</a>
    </form>
